...
const InternetBillingSuccessfulScreen = ({ navigation }) => {
  const handleConfirm = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.successSubtitle}>You've pay your internet bill!</Text>
...
export default InternetBillingSuccessfulScreen;