...
export default function WaterBillingConfirmScreen({ route, navigation }) {
  ...
  const handlePay = () => {
    ...
    navigation.navigate('WaterBillingSuccessful', {
      waterBoard,
      billNumber,
      amount,
      tax,
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.card}>
          <View style={styles.cardHeadingRow}>
            <Feather name="droplet" size={16} color="#2563EB" style={{ marginRight: 6 }} />
            <Text style={styles.cardHeading}>All the Bills</Text>
          </View>

          <View style={styles.row}>
            <Text style={styles.rowLabel}>Water board</Text>
            <Text style={styles.rowValue}>{waterBoard}</Text>
          </View>

          <View style={styles.row}>
            <Text style={styles.rowLabel}>Bill number</Text>
            <Text style={styles.rowValue}>{billNumber}</Text>
          </View>
        ...
        {/* TODO (Firebase/Backend): CARDS above is placeholder data —
            replace with the user's real saved payment methods once the
            backend/payment integration is ready */}
        <TouchableOpacity
